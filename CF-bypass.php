...
$host = "https://www.vape.gg/"; //$argv[1]; //website target
$proxy = "./proxies"; //$argv[5]; // proxy file (optional)
$cookies_c = 0;
$threads_in = "150"; //$argv[2];// how many threads
$whandlers = "300"; //$argv[4]; // how many cookies to generate (if proxies are set, the number of cookies will be the same of the proxies)
